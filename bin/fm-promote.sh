...
# task record naming no project it is none. bin/fm-brief.sh's --forge stays
# required because that script has no registry access at all;
# bin/fm-project-mode.sh's header owns the binding and bin/fm-dod-lib.sh owns what
# it changes for the worker.
