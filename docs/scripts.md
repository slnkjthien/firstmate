...
| `fm-project-mode.sh`     | Resolve a project's registered delivery posture and forge binding from `data/projects.md` for fleet sync, home seeding, and the spawn's forge agreement |
